...
ggsave("results/SCT.CCA/basic processing/celltype.splitby.group.umap.pdf",width = 12,height = 5)
...
write.table(deg1,file = "results/SCT.CCA/basic processing/celltype_deg.xls",sep = "\t")
...
ggsave(filename = "results/SCT.CCA/basic processing/celltype_marker_dotplot.pdf",width = 6,height = 5.5)
...
ggsave(filename = "results/SCT.CCA/basic processing/stack barplot.pdf",width = 4.5,height = 5)
...
ggsave(filename = "results/SCT.CCA/basic processing/Two-way bar charts_log2fc1.pdf",width = 4,height = 5)
